/*----- PROTECTED REGION ID(FourChannelAdapterClass.cpp) ENABLED START -----*/
//=============================================================================
//
// file :        FourChannelAdapterClass.cpp
//
// description : C++ source for the FourChannelAdapterClass.
//               A singleton class derived from DeviceClass.
//               It implements the command and attribute list
//               and all properties and methods required
//               by the FourChannelAdapter once per process.
//
// project :     
//
...
/*----- PROTECTED REGION END -----*/	//	FourChannelAdapterClass.cpp

//-------------------------------------------------------------------
/**
 *	Create FourChannelAdapterClass singleton and
...
__declspec(dllexport)
	...
	Tango::DeviceClass *_create_FourChannelAdapter_class(const char *name) {
		return FourChannelAdapter_ns::FourChannelAdapterClass::init(name);
	}
}
...
//===================================================================
FourChannelAdapterClass *FourChannelAdapterClass::_instance = NULL;

//--------------------------------------------------------
/**
 * method : 		FourChannelAdapterClass::FourChannelAdapterClass(string &s)
 * description : 	constructor for the FourChannelAdapterClass
 *
 * @param s	The class name
 */
//--------------------------------------------------------
FourChannelAdapterClass::FourChannelAdapterClass(string &s):Tango::DeviceClass(s)
{
...
//--------------------------------------------------------
/**
 * method : 		FourChannelAdapterClass::~FourChannelAdapterClass()
 * description : 	destructor for the FourChannelAdapterClass
 */
//--------------------------------------------------------
...
//--------------------------------------------------------
/**
 * method : 		FourChannelAdapterClass::init
 ...
 */
//--------------------------------------------------------
FourChannelAdapterClass *FourChannelAdapterClass::init(const char *name)
{
	if (_instance == NULL)
	{
		try
		{
			string s(name);
			_instance = new FourChannelAdapterClass(s);
		}
		catch (bad_alloc &)
		{
			throw;
...
//--------------------------------------------------------
/**
 * method : 		FourChannelAdapterClass::instance
 * description : 	Check if object already created,
 *                  and return a pointer to the object
 */
//--------------------------------------------------------
FourChannelAdapterClass *FourChannelAdapterClass::instance()
{
	if (_instance == NULL)
	{
...
CORBA::Any *StopMoveClass::execute(Tango::DeviceImpl *device, TANGO_UNUSED(const CORBA::Any &in_any))
{
	...
	((static_cast<FourChannelAdapter *>(device))->stop_move());
 ...
 */
//--------------------------------------------------------
Tango::DbDatum FourChannelAdapterClass::get_class_property(string &prop_name)
{
...
//--------------------------------------------------------
/**
 *	Method      : FourChannelAdapterClass::get_default_device_property()
 *	Description : Return the default value for device property.
 */
//--------------------------------------------------------
Tango::DbDatum FourChannelAdapterClass::get_default_device_property(string &prop_name)
{
...
//--------------------------------------------------------
/**
 *	Method      : FourChannelAdapterClass::get_default_class_property()
 *	Description : Return the default value for class property.
 */
//--------------------------------------------------------
Tango::DbDatum FourChannelAdapterClass::get_default_class_property(string &prop_name)
{
...
//--------------------------------------------------------
/**
 *	Method      : FourChannelAdapterClass::set_default_property()
 ...
 */
//--------------------------------------------------------
void FourChannelAdapterClass::set_default_property()
{
	string	prop_name;
	string	prop_desc;
	string	prop_def;
	...
	prop_name = "Channel";
	prop_desc = "channel of the motor";
	prop_def  = "0";
	vect_data.clear();
	...
	if (prop_def.length()>0)
	{
		...
		add_wiz_dev_prop(prop_name, prop_desc);
	prop_name = "EncoderGrayCode";
	prop_desc = "Convert encoder value from gray code";
	prop_def  = "true";
	vect_data.clear();
...
//--------------------------------------------------------
/**
 *	Method      : FourChannelAdapterClass::write_class_property()
 *	Description : Set class description fields as property in database
 */
//--------------------------------------------------------
void FourChannelAdapterClass::write_class_property()
{
...
//--------------------------------------------------------
/**
 *	Method      : FourChannelAdapterClass::device_factory()
 *	Description : Create the device object(s)
 *                and store them in the device list
 */
//--------------------------------------------------------
void FourChannelAdapterClass::device_factory(const Tango::DevVarStringArray *devlist_ptr)
{
	/*----- PROTECTED REGION ID(FourChannelAdapterClass::device_factory_before) ENABLED START -----*/
	
	//	Add your own code
	
	/*----- PROTECTED REGION END -----*/	//	FourChannelAdapterClass::device_factory_before

	//	Create devices and add it into the device list
	for (unsigned long i=0 ; i<devlist_ptr->length() ; i++)
	{
		cout4 << "Device name : " << (*devlist_ptr)[i].in() << endl;
		device_list.push_back(new FourChannelAdapter(this, (*devlist_ptr)[i]));
	}
	...
	for (unsigned long i=1 ; i<=devlist_ptr->length() ; i++)
	{
		...
		FourChannelAdapter *dev = static_cast<FourChannelAdapter *>(device_list[device_list.size()-i]);
	...
	/*----- PROTECTED REGION ID(FourChannelAdapterClass::device_factory_after) ENABLED START -----*/
	
	//	Add your own code
	
	/*----- PROTECTED REGION END -----*/	//	FourChannelAdapterClass::device_factory_after
}
//--------------------------------------------------------
/**
 *	Method      : FourChannelAdapterClass::attribute_factory()
 *	Description : Create the attribute object(s)
 *                and store them in the attribute list
 */
//--------------------------------------------------------
void FourChannelAdapterClass::attribute_factory(vector<Tango::Attr *> &att_list)
{
	/*----- PROTECTED REGION ID(FourChannelAdapterClass::attribute_factory_before) ENABLED START -----*/
	
	//	Add your own code
	
	/*----- PROTECTED REGION END -----*/	//	FourChannelAdapterClass::attribute_factory_before
	//	Attribute : Position
	...
	/*----- PROTECTED REGION ID(FourChannelAdapterClass::attribute_factory_after) ENABLED START -----*/
	
	//	Add your own code
	
	/*----- PROTECTED REGION END -----*/	//	FourChannelAdapterClass::attribute_factory_after
}
//--------------------------------------------------------
/**
 *	Method      : FourChannelAdapterClass::pipe_factory()
 *	Description : Create the pipe object(s)
 *                and store them in the pipe list
 */
//--------------------------------------------------------
void FourChannelAdapterClass::pipe_factory()
{
	/*----- PROTECTED REGION ID(FourChannelAdapterClass::pipe_factory_before) ENABLED START -----*/
	
	//	Add your own code
	
	/*----- PROTECTED REGION END -----*/	//	FourChannelAdapterClass::pipe_factory_before
	/*----- PROTECTED REGION ID(FourChannelAdapterClass::pipe_factory_after) ENABLED START -----*/
	
	//	Add your own code
	
	/*----- PROTECTED REGION END -----*/	//	FourChannelAdapterClass::pipe_factory_after
}
//--------------------------------------------------------
/**
 *	Method      : FourChannelAdapterClass::command_factory()
 *	Description : Create the command object(s)
 *                and store them in the command list
 */
//--------------------------------------------------------
void FourChannelAdapterClass::command_factory()
{
	/*----- PROTECTED REGION ID(FourChannelAdapterClass::command_factory_before) ENABLED START -----*/
	
	//	Add your own code
	
	/*----- PROTECTED REGION END -----*/	//	FourChannelAdapterClass::command_factory_before
	...
	/*----- PROTECTED REGION END -----*/	//	FourChannelAdapterClass::command_factory_after
}
...
//--------------------------------------------------------
/**
 * method : 		FourChannelAdapterClass::create_static_attribute_list
 * description : 	Create the a list of static attributes
 *
 * @param	att_list	the ceated attribute list
 */
//--------------------------------------------------------
void FourChannelAdapterClass::create_static_attribute_list(vector<Tango::Attr *> &att_list)
{
	...
	/*----- PROTECTED REGION ID(FourChannelAdapterClass::create_static_att_list) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	FourChannelAdapterClass::create_static_att_list
}


//--------------------------------------------------------
/**
 * method : 		FourChannelAdapterClass::erase_dynamic_attributes
 ...
 */
//--------------------------------------------------------
void FourChannelAdapterClass::erase_dynamic_attributes(const Tango::DevVarStringArray *devlist_ptr, vector<Tango::Attr *> &att_list)
{
	...
	for (unsigned long i=0 ; i<devlist_ptr->length() ; i++)
	{
		...
		FourChannelAdapter *dev = static_cast<FourChannelAdapter *> (dev_impl);
	...
	/*----- PROTECTED REGION ID(FourChannelAdapterClass::erase_dynamic_attributes) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	FourChannelAdapterClass::erase_dynamic_attributes
}

//--------------------------------------------------------
/**
 *	Method      : FourChannelAdapterClass::get_attr_by_name()
 *	Description : returns Tango::Attr * object found by name
 */
//--------------------------------------------------------
Tango::Attr *FourChannelAdapterClass::get_attr_object_by_name(vector<Tango::Attr *> &att_list, string attname)
{
...
/*----- PROTECTED REGION ID(FourChannelAdapterClass::Additional Methods) ENABLED START -----*/

/*----- PROTECTED REGION END -----*/	//	FourChannelAdapterClass::Additional Methods
} //	namespace
